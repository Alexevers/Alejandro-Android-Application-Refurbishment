        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                'You can also get information about our Privacy Policies \n',
                textAlign: TextAlign.center,
                style: TextStyle(fontSize: 17),
              ),
              GestureDetector(
                onTap: () {
                  _launchURL('https://github.com/Alexevers/Alejandro-Android-Application-Refurbishment/blob/RAS/reforestation-assistant-simulator/PrivacyPolicy.md');
                },
                child: Text(
                  'Privacy Policy RAS',
                  textAlign: TextAlign.center,
