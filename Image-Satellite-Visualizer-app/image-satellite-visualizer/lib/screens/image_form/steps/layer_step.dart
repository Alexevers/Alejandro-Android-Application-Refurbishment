...
List<Map<String, dynamic>> nasaLayers = [
  {
    ...
    "components": [
      ...
      },
      {
        ...
        "description":
            "This combination is used to map snow and ice. Snow and ice are very reflective in the visible part of the spectrum (Band 3), and very absorbent in Bands 6 and 7 (short-wave infrared, or SWIR). This band combination is good for distinguishing liquid water from frozen water, for activity, clouds over snow, ice cloud versus water cloud; or floods from dense vegetation. This band combination is only available for MODIS (Terra) because 70% of the band 6 sensors on the MODIS instrument on NASA's Aqua satellite failed shortly after launch.",
        "url":
            "https://earthdata.nasa.gov/faq/worldview-snapshots-faq#base-layers",
        "colors": [
          {
  ...
  },
  {
    ...
    "components": [
      ...
      },
      {
        ...
        "description":
            "This combination is used to map snow and ice. Snow and ice are very reflective in the visible part of the spectrum (Band M3), and very absorbent in Bands I3 and M11 (short-wave infrared, or SWIR). This band combination is good for distinguishing liquid water from frozen water, for activity, clouds over snow, ice cloud versus water cloud; or floods from dense vegetation. The VIIRS instrument in aboard the joint NASA/NOAA Suomi NPP satellite.",
        "url":
            "https://earthdata.nasa.gov/faq/worldview-snapshots-faq#base-layers",
        "colors": [
          {
