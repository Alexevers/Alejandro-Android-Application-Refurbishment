...
With this code, the controller will start its connection to the previously informed network and does not accept updating network data through the application of this project, 
